...
var Database = /** @class */ (function () {
    ...
    function Database() {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.executeSQL(schema_1.ACCOUNTS)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        this.executeTransaction = function (queries) { return __awaiter(_this, void 0, void 0, function () {
            var conn, _i, queries_1, query, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 5:
                        _i++;
                        return [3 /*break*/, 3];
                    case 6: return [4 /*yield*/, conn.commit()];
                    case 7:
                        _a.sent();
                        return [3 /*break*/, 12];
                    case 8:
